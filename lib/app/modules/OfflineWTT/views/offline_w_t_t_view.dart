...
class OfflineWTTView extends GetView<OfflineWTTController> {
   ...
   OfflineWTTController offlineWTTController=Get.put(OfflineWTTController());
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:offlineWTTController.isLoading.value?CircularProgressIndicator():Container(
        padding: EdgeInsets.all(10),
        child:Obx(()=> Center(child: SfPdfViewer.network('https://service-manager.digiatto.online/${offlineWTTController.wttname.value}',)
        // cached_network_image(image: "https://service-manager.digiatto.online/${offlineWTTController.wttname.value}", fit:BoxFit.contain)
        )
        ),
      ),
